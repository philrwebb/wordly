...
var app = (function () {
    ...
    // (137:4) {#if $gameData.gameWon || (!$gameData.gameWon && $gameData.currentRow > 5)}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 137, 6, 4386);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(137:4) {#if $gameData.gameWon || (!$gameData.gameWon && $gameData.currentRow > 5)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 131, 2, 4131);
    			attr_dev(p, "class", "svelte-1juoyqj");
    			add_location(p, file, 132, 2, 4202);
    			attr_dev(span, "class", "rows svelte-1juoyqj");
    			add_location(span, file, 141, 2, 4455);
    			attr_dev(div, "class", "container svelte-1juoyqj");
    			add_location(div, file, 130, 0, 4105);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
