...
var app = (function () {
    ...
    // (130:4) {#if $gameData.gameWon || (!$gameData.gameWon && $gameData.currentRow > 5)}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 130, 6, 4158);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(130:4) {#if $gameData.gameWon || (!$gameData.gameWon && $gameData.currentRow > 5)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 124, 2, 3905);
    			attr_dev(p, "class", "svelte-1b0z11a");
    			add_location(p, file, 125, 2, 3974);
    			attr_dev(span, "class", "rows");
    			add_location(span, file, 134, 2, 4227);
    			attr_dev(div, "class", "container svelte-1b0z11a");
    			add_location(div, file, 123, 0, 3879);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		set_store_value(gameData, $gameData.wordToGuess = word, $gameData);
    		console.log(word);
    	});
