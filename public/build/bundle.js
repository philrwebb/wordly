...
var app = (function () {
    ...
    // (128:4) {#if $gameData.gameWon || (!$gameData.gameWon && $gameData.currentRow > 5)}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 128, 6, 4151);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(128:4) {#if $gameData.gameWon || (!$gameData.gameWon && $gameData.currentRow > 5)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 122, 2, 3898);
    			attr_dev(p, "class", "svelte-1b0z11a");
    			add_location(p, file, 123, 2, 3967);
    			attr_dev(span, "class", "rows");
    			add_location(span, file, 132, 2, 4220);
    			attr_dev(div, "class", "container svelte-1b0z11a");
    			add_location(div, file, 121, 0, 3872);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
